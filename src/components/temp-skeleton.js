var createScene = async function () {
   ...
   BABYLON.SceneLoader.ImportMesh("", "./scenes/", "dummy3.babylon", scene, function (newMeshes, particleSystems, skeletons) {
      ...
      // helper.setMainColor(BABYLON.Color3.Gray());
       ...
       // ..
       var button = BABYLON.GUI.Button.CreateSimpleButton("but1", "initial");
       ...
       var button1 = BABYLON.GUI.Button.CreateSimpleButton("butstop", "Stop walk");
       ...
       button1.onPointerDownObservable.add(() => {
           if (walkRange) scene.stopAnimation(skeleton);
       });
